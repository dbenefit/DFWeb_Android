package com.dffl.dflibrary.scan.litezxing;
/*
...
import static com.dffl.dflibrary.scan.litezxing.ViewfinderView.FrameGravity.CENTER;
...
import com.dffl.dflibrary.scan.litezxing.util.LogUtils;
...
public class ViewfinderView extends View {
    ...
    private void init(Context context, AttributeSet attrs) {
        //初始化自定义属性信息
        TypedArray array = context.obtainStyledAttributes(attrs, R.styleable.DFViewfinderView);
        maskColor = array.getColor(R.styleable.DFViewfinderView_df_maskColor, ContextCompat.getColor(context, R.color.dfviewfinder_mask));
        frameColor = array.getColor(R.styleable.DFViewfinderView_df_frameColor, ContextCompat.getColor(context, R.color.dfviewfinder_frame));
        cornerColor = array.getColor(R.styleable.DFViewfinderView_df_cornerColor, ContextCompat.getColor(context, R.color.dfviewfinder_corner));
        laserColor = array.getColor(R.styleable.DFViewfinderView_df_laserColor, ContextCompat.getColor(context, R.color.dfviewfinder_laser));

        labelText = array.getString(R.styleable.DFViewfinderView_df_labelText);
        labelTextColor = array.getColor(R.styleable.DFViewfinderView_df_labelTextColor, ContextCompat.getColor(context, R.color.dfviewfinder_text_color));
        labelTextSize = array.getDimension(R.styleable.DFViewfinderView_df_labelTextSize, TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_SP,14f,getResources().getDisplayMetrics()));
        labelTextPadding = array.getDimension(R.styleable.DFViewfinderView_df_labelTextPadding,TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP,24,getResources().getDisplayMetrics()));
        labelTextWidth = array.getDimensionPixelSize(R.styleable.DFViewfinderView_df_labelTextWidth,0);
        labelTextLocation = TextLocation.getFromInt(array.getInt(R.styleable.DFViewfinderView_df_labelTextLocation,0));

        frameWidth = array.getDimensionPixelSize(R.styleable.DFViewfinderView_df_frameWidth,0);
        frameHeight = array.getDimensionPixelSize(R.styleable.DFViewfinderView_df_frameHeight,0);

        laserStyle = LaserStyle.getFromInt(array.getInt(R.styleable.DFViewfinderView_df_laserStyle,LaserStyle.LINE.mValue));
        gridColumn = array.getInt(R.styleable.DFViewfinderView_df_gridColumn,20);
        gridHeight = (int)array.getDimension(R.styleable.DFViewfinderView_df_gridHeight,TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP,40,getResources().getDisplayMetrics()));

        cornerRectWidth = (int)array.getDimension(R.styleable.DFViewfinderView_df_cornerRectWidth,TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP,4,getResources().getDisplayMetrics()));
        cornerRectHeight = (int)array.getDimension(R.styleable.DFViewfinderView_df_cornerRectHeight,TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP,16,getResources().getDisplayMetrics()));
        scannerLineMoveDistance = (int)array.getDimension(R.styleable.DFViewfinderView_df_scannerLineMoveDistance,TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP,2,getResources().getDisplayMetrics()));
        scannerLineHeight = (int)array.getDimension(R.styleable.DFViewfinderView_df_scannerLineHeight,TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP,5,getResources().getDisplayMetrics()));
        frameLineWidth = (int)array.getDimension(R.styleable.DFViewfinderView_df_frameLineWidth,TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP,1,getResources().getDisplayMetrics()));
        scannerAnimationDelay = array.getInteger(R.styleable.DFViewfinderView_df_scannerAnimationDelay,20);
        frameRatio = array.getFloat(R.styleable.DFViewfinderView_df_frameRatio,0.625f);
        framePaddingLeft = array.getDimension(R.styleable.DFViewfinderView_df_framePaddingLeft,0);
        framePaddingTop = array.getDimension(R.styleable.DFViewfinderView_df_framePaddingTop,0);
        framePaddingRight = array.getDimension(R.styleable.DFViewfinderView_df_framePaddingRight,0);
        framePaddingBottom = array.getDimension(R.styleable.DFViewfinderView_df_framePaddingBottom,0);
        frameGravity = FrameGravity.getFromInt(array.getInt(R.styleable.DFViewfinderView_df_frameGravity, CENTER.mValue));
        array.recycle();
