...
import com.dffl.dfscanlib.litezxing.util.PermissionUtils;
    ...
    public void requestCameraPermissionResult(@NonNull String[] permissions, @NonNull int[] grantResults) {
        if (PermissionUtils.requestPermissionsResult(Manifest.permission.CAMERA, permissions, grantResults)) {
            ...
            try {
                ...
                new AlertDialog.Builder(this).setTitle("权限").setMessage("相机权限未开启，请在设置中开启" + applicationName + "相机权限").setNegativeButton("取消", new DialogInterface.OnClickListener() {
                    @Override
